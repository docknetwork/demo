...
const credentialOffers = [
  ...
  },
  {
    ...
    description:
      'Show your appreciation to your employees by choosing an employee of the month and giving them a certificate',
    icon: (
        ...
        {credentialOffers.map((offer) => (
          <div className="p-10 flex flex-col items-center text-center group md:lg:xl:border-r md:lg:xl:border-b hover:bg-slate-50 cursor-pointer">
            ...
            <div className="flex flex-wrap justify-center space-x-2">
              <span className="px-4 py-2 rounded-full border border-gray-300 text-gray-500 font-semibold text-sm flex align-center w-max cursor-pointer active:bg-gray-300 transition duration-300 ease">
                Text
              </span>
            </div>
          </div>
...
export default function Dashboard() {
  return (
    <Layout>
      <InfoAlert>
        Here are requests to present credentials for verification, such as obtaining airline
        tickets? idk
      </InfoAlert>
      <CredentialSelector />
    </Layout>
