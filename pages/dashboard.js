    ...
    <div className="px-3 md:lg:xl:px-10 py-5 bg-opacity-10">
      ...
      <div className="w-full shadow-xl border py-10 px-14 my-10 flex justify-between items-center rounded-lg">
        <p className=" text-white">
          ...
          <span className="text-md">Contact us at Dock to book a consultation call</span>
        </p>
        <button
          type="submit"
          style={{ width: '158px' }}
          className="block bg-blue-600 mt-auto mb-auto py-2 rounded-full hover:bg-blue-700 hover:-translate-y-1 transition-all duration-250 text-white font-semibold">
          Contact Us
        </button>
      </div>
    </div>
